              ...
              <div class="bg-white rounded-xl p-4 shrink-0 w-[260px] flex flex-col gap-2.5">
                ...
                <div class="flex items-start gap-2">
                  ...
                  {#if !event.cover_photo_url}
                    <div class="shrink-0 flex flex-col items-center justify-center select-none w-9 h-9 rounded-lg" style="background: hsl(220 14% 93%)">
                      ...
                      <span class="font-bold leading-none mt-0.5" style="font-size: 1.1rem; color: hsl(220 9% 50%)">{new Date(event.event_date).getDate()}</span>
                    </div>
                  {/if}
                </div>
                ...
                <!-- Event image: 4:3 -->
                {#if event.cover_photo_url}
                  <div class="w-full rounded-lg overflow-hidden" style="aspect-ratio: 4/3">
  ...
  <div class="hidden md:flex flex-col w-80 shrink-0 overflow-hidden" style="background: hsl(234 20% 96%)">
    ...
    <div class="px-6 pt-5 pb-3 shrink-0">
      ...
      <div class="flex items-center gap-3 pt-2">
        <span class="flex items-center gap-1.5" style="font-size: 10px; color: hsl(220 9% 55%)">
          <span class="w-1.5 h-1.5 rounded-full shrink-0" style="background: hsl(35 100% 55%)"></span>Going
        </span>
        <span class="flex items-center gap-1.5" style="font-size: 10px; color: hsl(220 9% 55%)">
          <span class="w-1.5 h-1.5 rounded-full shrink-0" style="background: hsl(355 68% 62%)"></span>Maybe
        </span>
        <span class="flex items-center gap-1.5" style="font-size: 10px; color: hsl(220 9% 55%)">
          <span class="w-1.5 h-1.5 rounded-full shrink-0" style="background: hsl(355 68% 73%)"></span>Can't go
        </span>
      </div>
    </div>
        ...
        {#each upcomingEvents as event}
          ...
          <div id="cal-event-{event.id}" class="bg-white rounded-xl">
            <div class="p-4">
              ...
              <!-- Event image: 4:3 -->
              {#if event.cover_photo_url}
                <div class="w-full rounded-lg overflow-hidden mb-3" style="aspect-ratio: 4/3">
                  <img src={event.cover_photo_url} alt={event.title} class="w-full h-full object-cover" />
                </div>
              {/if}
