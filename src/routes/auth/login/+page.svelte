...
<div class="min-h-screen bg-background flex items-center justify-center px-4">
  <div class="w-full max-w-sm">
    ...
    <div class="text-center mb-8">
      ...
      <p class="text-sm text-muted-foreground mt-1">Sign in to your groups.</p>
    </div>
    ...
    <form onsubmit={(e) => { e.preventDefault(); handleLogin() }} class="flex flex-col gap-3">
      ...
      <div class="flex flex-col gap-1.5">
        <div class="flex items-center justify-between">
          ...
          <a href="/auth/forgot-password" class="text-xs text-muted-foreground hover:underline" style="color: hsl(234 26% 41%)">Forgot password?</a>
        </div>
        <input
          id="password"
          type="password"
    ...
    <p class="text-center text-sm text-muted-foreground mt-6">
      ...
      <a href="/auth/signup" class="font-medium" style="color: hsl(234 26% 41%)">Create one</a>
    </p>
