...
<div class="min-h-screen relative overflow-hidden" style="background-color: var(--color-header);">
  ...
  <!-- Single layout container — stacked on mobile, side-by-side on desktop -->
  <div class="min-h-screen flex flex-col items-center justify-center px-4 py-8 md:flex-row md:justify-center md:px-0" style="gap: 0; --desktop-gap: 80px;">

    <!-- Mobile: wordmark + illustration (hidden on desktop) -->
    ...
    <!-- Form column -->
    <div class="w-full max-w-sm md:max-w-sm" style="md:margin-right: var(--desktop-gap)">

      <!-- Desktop-only heading -->
      <div class="hidden md:block mb-8">
        <h1 class="text-2xl font-bold mb-1" style="color: white;">Welcome back</h1>
        <p class="text-sm" style="color: rgba(255,255,255,0.5);">Sign in to your account.</p>
      </div>
    ...
    <div class="hidden md:flex items-center justify-center pb-12" style="margin-left: 80px;">
